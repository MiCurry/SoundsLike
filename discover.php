        ...
        <div class = "tabbable">
            ...
            <div class="tab-content">
                ...
                <?php
                    ...
                    $query =  ("SELECT A.name Artist, A.Location AS Location, G.Name AS Genre, A2.name AS SoundsLike 
                        FROM genres G
                ...
                <div class="tab-pane" id="album">
                     <div class="container">
                        <table class = "table table-hover">
                            <tr><th>Album</th><th>Artist</th><th>Producer</th></tr>
                    <?php
